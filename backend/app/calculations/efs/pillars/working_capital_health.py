"""Working Capital Health Pillar Engine."""
...
class WorkingCapitalHealthPillar(BasePillarEngine):
    """Pillar 4: Working Capital Health Engine."""

    @property
    def name(self) -> str:
        return "Working Capital Health"

    @property
    def canonical_key(self) -> str:
        return "working_capital_health"
    ...
    def calculate(
        ...
        return PillarResult(
            ...
            status="computed",
            variables_used=used_vars,
            strengths=["Receivable conversion cycle matches peer averages."],
            weaknesses=[],
            red_flags=[],
