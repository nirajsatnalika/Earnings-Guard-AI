...
class AccrualQualityPillar(BasePillarEngine):
    """Pillar 3: Accrual Quality Engine."""
    ...
    def calculate(
        ...
        return PillarResult(
            ...
            status="computed",
            variables_used=used_vars,
            strengths=["Total accruals within expected variance band."],
            weaknesses=[],
            red_flags=[],
