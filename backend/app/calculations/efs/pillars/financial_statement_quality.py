"""Financial Statement Quality Pillar Engine."""
...
class FinancialStatementQualityPillar(BasePillarEngine):
    """Pillar 1: Financial Statement Quality Engine."""

    @property
    def name(self) -> str:
        return "Financial Statement Quality"

    @property
    def canonical_key(self) -> str:
        return "financial_statement_quality"
    ...
    def calculate(
        ...
        return PillarResult(
            ...
            status="computed",
            variables_used=used_vars,
            strengths=["Financial statements pass baseline structural validation checks."],
            weaknesses=[],
            red_flags=[],
