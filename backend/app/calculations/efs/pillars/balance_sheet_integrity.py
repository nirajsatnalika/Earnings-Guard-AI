"""Balance Sheet Integrity Pillar Engine."""
...
class BalanceSheetIntegrityPillar(BasePillarEngine):
    """Pillar 5: Balance Sheet Integrity Engine."""

    @property
    def name(self) -> str:
        return "Balance Sheet Integrity"

    @property
    def canonical_key(self) -> str:
        return "balance_sheet_integrity"
    ...
    def calculate(
        ...
        return PillarResult(
            ...
            status="computed",
            variables_used=used_vars,
            strengths=["Asset values supported by historical valuation models."],
            weaknesses=[],
            red_flags=[],
